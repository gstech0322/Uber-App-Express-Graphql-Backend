...
const categoryMarkerUpload = app => {
    ...
    app.post('/deleteCategoryMarker', function (req, res, next) {
        next()
    }, async (req, res, next) => {
    ...
    app.post('/uploadCategoryMarker', function (req, res, next) {
        next();
...
export default categoryMarkerUpload;